...
<div class="sf-settings sf-tabs-target" id="sf-settings" data-filter_group_id="<?php echo esc_attr( \Hybrid\app( 'prefix' ) . '-' . get_the_ID() ); ?>">
    ...
    <div class="sf-settings__wrap">
        ...
        <div class="sf-settings__notice">
            <?php
            printf( wp_kses_post( __( 'To change filter appearance go to <a href="%s">global settings</a>', $locale ) ),
